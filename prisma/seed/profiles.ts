...
export function seedUserSpecs(password: string): SeedUserSpec[] {
  return [
    ...
    },
    {
      ...
      phoneE164: '+971560900602',
      city: 'Dubai',
      country: 'United Arab Emirates',
      countryCode: 'AE',
      locationCode: 'dubai',
      title: 'Creative Production Studio',
      bio: 'Dubai studio specializing in brand launches, campaign art direction, and content systems for hospitality, retail, and tech. We hire independent talent for overflow and specialty work.',
      skills: [
        'Campaign Design',
        'Art Direction',
        'Content Strategy',
